...
<div class="form-group row mb-3">
    {!! Form::label('cheat_medium', 'बैंकको प्रकार *', ['class' => 'col-3 col-form-label']) !!}
    <div class="col-9">
    {!! Form::select('bank_type_id', $bankTypes, null, ['class' => "form-control", 'id' => 'bank_type_id', 'placeholder' => 'बैंकको प्रकार ...']) !!}
    @include('error.single_field_validation_message',['fieldname' => 'bank_type_id'])
    </div>
</div>
<div class="form-group row mb-3">
    {!! Form::label('cheat_medium', 'बैंकको नाम *', ['class' => 'col-3 col-form-label']) !!}
    <div class="col-9">
    {!! Form::text('cheat_medium', null, ['class' => "form-control", 'id' => 'cheat_medium', 'placeholder' => 'बैंकको नाम ...']) !!}
